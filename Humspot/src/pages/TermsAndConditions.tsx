  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        <IonText>
          <h2>Welcome to Humspots</h2>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of HumSpot's Website, located at https://humspot.com. By
          ...
          <ol>
            ...
            <li><strong>Links to Other Websites </strong>
              ...
              by Humspots. Humspots has no control over,
              ...
              acknowledge and agree that Humspots shall not be
            ...
            <li><strong>Contact</strong>
              ...
              contact us at Humspots.humboldt.edu</p>
            </li>
          </ol>
